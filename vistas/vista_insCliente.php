        ...
        <div class="modal-body" >
			...
			<?php } ?>
               ...
               <div class="form-group col-md-4">
                    ...
                    <input type="text" name="patente1" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" name="marca" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="number" name="modelo" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
                ...
                <div class="form-group col-md-2">
                    <label for="">Año: </label>
                    <input type="number" name="anio" class="form-control <?php //echo (isset($error['Correo']))?"is-invalid":""; ?>"  value="" placeholder=""   >
                    <div class="invalid-feedback">
                        <?php// echo (isset($error['Correo']))?$error['Correo']:""; ?>
                    </div>
                    <br>
